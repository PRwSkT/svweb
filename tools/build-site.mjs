    ...
    <div class="footer-grid">
      <div class="footer-col">
        ...
        <div class="footer-social" style="margin-top: 20px;">
          ...
          ${siteSettings.line ? `<a href="https://line.me/R/ti/p/${siteSettings.line.startsWith('@') ? siteSettings.line : '@' + siteSettings.line}" target="_blank" rel="noopener noreferrer" aria-label="LINE"><svg width="22" height="22" viewBox="0 0 24 24">  <circle cx="12" cy="12" r="12" fill="white"></circle>  <path fill="#00C300" fill-rule="evenodd" clip-rule="evenodd" d="M19.365 9.863c0-3.968-3.961-7.228-8.851-7.228-4.89 0-8.852 3.26-8.852 7.228 0 3.567 3.123 6.608 7.391 7.152.288.062.68.179.778.435.09.231.029.588-.037.818-.112.387-.528 2.062-.647 2.585-.152.658.337.859.852.545.986-.6 5.311-3.269 7.288-5.385C18.665 14.195 19.365 12.186 19.365 9.863zM9.467 11.233H7.815V8.125c0-.236-.182-.418-.418-.418s-.418.182-.418.418v3.526c0 .236.182.418.418.418h2.07c.236 0 .418-.182.418-.418s-.182-.418-.418-.418zm1.942.418H10.57v-3.526c0-.236.182-.418.418-.418s.418.182.418.418v3.526zM15.42 8.125c0-.236-.182-.418-.418-.418h-1.637c-.236 0-.418.182-.418.418v3.526c0 .236.182.418.418.418h1.637c.236 0 .418-.182.418-.418s-.182-.418-.418-.418h-1.219v-1.139h1.219c.236 0 .418-.182.418-.418s-.182-.418-.418-.418h-1.219V8.543h1.219c.236 0 .418-.182.418-.418zm4.61-3.957H20.03v3.526c0 .236-.182.418-.418.418h-2.07c-.236 0-.418-.182-.418-.418s.182-.418.418-.418h1.652V8.125c0-.236.182-.418.418-.418s.418.182.418.418z"></path></svg></a>` : ''}
        </div>
      </div>
      <div class="footer-col">
...
<body class="${page.path === '/' ? 'is-home' : ''}">
  ...
  <script src="/main.js?v=1787404807" defer></script>
