...
function textSections(page, locale) {
  console.log("PAGE TYPE:", page.type, "SECTIONS:", page.sections);
...
function homeSections(page, locale) {
  return `${stats(locale)}${quickLinks(locale)}${directorQuote(locale)}${programCards(locale)}${textSections(page, locale)}${news(locale)}${formSection(locale, "quick-inquiry")}`;
}
