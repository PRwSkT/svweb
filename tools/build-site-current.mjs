...
function homeVideoSection(locale) {
  ...
  <div class="director-quote-container" style="align-items: center;">
    ...
    <div style="flex: 0 0 45%; display: flex; justify-content: center;">
      <iframe src="https://www.youtube.com/embed/HBVkXyl8GVw?si=TE8888H4bXtYiacA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="width: 100%; max-width: 480px; aspect-ratio: 16/9; border: none; display: block;"></iframe>
    </div>
  </div>
</section>`;
}
